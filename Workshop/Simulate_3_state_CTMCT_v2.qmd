...
### Simulate Paths - Exponential CLocks
```{r}
#| code-fold: TRUE
#| code-summary: "Show the code"
#|
...
ggplot(survival_data, aes(x = survival_time, color = factor(start_state))) +
  stat_ecdf(aes(y = after_stat(1 - y)), linewidth = 1.5) +
  labs(
...
ggarrange(tbl1, tbl2, tbl3,
          labels = c("Time in States 1 & 2", "First Hitting Times", "Time to Absorption"),
